...
DefaultRenderer::DefaultRenderer(int _type, ShaderType _shader, int _textureID, ProjectionType _projectionType) : Renderer(_type, _shader, _textureID, _projectionType)
{
